...
<?echo $arResult["NAME"]?>, <?=$arResult["DISPLAY_ACTIVE_FROM"]?>, <?echo $arResult["PROPERTIES"]["POSITION"]["VALUE"]?>, <?echo $arResult["PROPERTIES"]["COMPANY"]["VALUE"]?>
</div>
</div>
...
<p>Документы:</p>
<?php foreach ($arResult["DISPLAY_PROPERTIES"]["DOC"]["FILE_VALUE"] as $key ): ?>
