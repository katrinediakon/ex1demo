...
<nav class="menu-block">
	<ul>
		<li class="att popup-wrap"><a id="hd_singin_but_open" href="<?=$arResult["AUTH_REGISTER_URL"]?>" class="btn-toggle"><?=GetMessage("AUTH_LOGIN_LINK_TEXT")?></a>
	...
	<table width="95%">
		<tr>
			<td align="center">
				...
				<a style="color:black" href="<?=$arResult["PROFILE_URL"]?>" title="<?=GetMessage("AUTH_PROFILE")?>">	<?=$arResult["USER_NAME"]?>[<?=$arResult["USER_LOGIN"]?>]<br /></a><br />
			</td>
		</tr>
		<tr>
			<td align="center">
